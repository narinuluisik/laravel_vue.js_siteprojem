<template>
  <div class="container mt-4">
    ...
    <form @submit.prevent="createMember" class="bg-white p-4 rounded shadow-sm">
      <div class="mb-3">
...
export default {
  ...
  methods: {
    async createMember() {
      try {
        await axios.post('/admin/team-members', this.member);
        alert('Takım üyesi başarıyla eklendi!');
        this.$router.push('/admin/about'); // uygun liste sayfası
      } catch (error) {
        console.error('Takım üyesi eklenirken hata:', error);
